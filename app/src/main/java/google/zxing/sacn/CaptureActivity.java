...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	public void onCreate(Bundle icicle) {
		...
		buttonCannel = (Button) findViewById(R.id.capture_button_cancel);
		buttonCannel.setOnClickListener(new OnClickListener() {
			@Override
	...
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
		...
		Log.i("test", "type =" + ResultParser.parseResult(rawResult).getType() + ";" + ResultParser.parseResult(rawResult).toString());
		Toast.makeText(getApplicationContext(), "扫描成功 : " + ResultParser.parseResult(lastResult).toString(), Toast.LENGTH_SHORT).show();
		// finish();
		...
		intt.putExtra("code", ResultParser.parseResult(lastResult).toString());
		setResult(100, intt);
		finish();
	}
	...
	private void displayFrameworkBugMessageAndExit() {
		...
		builder.setPositiveButton(getResources().getString(R.string.OK), new FinishListener(this));
