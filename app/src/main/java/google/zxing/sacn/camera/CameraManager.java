...
package google.zxing.sacn.camera;

import google.zxing.sacn.camera.open.OpenCameraManager;
...
//			framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);
			framingRect = new Rect(0, SysUtils.dipToPx(context, 85),screenResolution.x,screenResolution.y-SysUtils.dipToPx(context, 95) );
